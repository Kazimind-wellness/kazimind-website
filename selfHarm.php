...
ob_start();
session_start();
$pageTitle = "Suicide and Self-Harm Support";
?>
...
<head>
    ...
    <title>Kazimind - Suicide Prevention</title>
</head>
...
<div class="mainB">
    ...
    <div class="section-container scroll-animate">
        ...
        <p class="description">
            <strong>Suicidal</strong> ideation refers to having thoughts about suicide. For some, these thoughts may come with urges or actions, while for others, they remain as thoughts sometimes intrusive that can surface in response to triggers or persist either in the background or more intensely in daily life.
