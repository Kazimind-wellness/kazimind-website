...
<head>
    ...
    <title>Kazimind - Trauma Support</title>
</head>
...
<div class="mainB">
    ...
    <div class="section-container section scroll-animate">
        ...
        <p class="intro-paragraph">
            <strong>Trauma</strong> can happen to anyone and can cause significant distress and disruption. Trauma can come from "Big T Trauma" events like war or assault, and it can also come from "small t trauma" events like medical challenges, relocation, or accidents that were just barely avoided. The majority of our therapists at Kazimind Wellness Centre work with trauma, and we can support you however you need - through debriefing, processing or problem solving.
        </p>
    </div>
    ...
    <div class="section-container scroll-animate">
        ...
        <p class="description">
            <strong>Post-Traumatic Stress Disorder (PTSD)</strong> and <strong>Complex-PTSD (C-PTSD)</strong> are diagnoses people may receive after experiencing traumatic event(s). While PTSD usually comes from a single incident trauma (think of a car accident, or a traumatic birth), C-PTSD tends to develop because of chronic or repeated trauma (think of on-going abuse, bullying, or victims of kidnapping).<br><br>
            Both PTSD and C-PTSD can result in the development of disrupting symptoms such as feeling on edge, re-experiencing or flashing back to the event, dissociation, avoiding people or places that remind you of the event, and feeling disconnected or distant from other people. If you are struggling with any of these things, regardless of if you have a diagnosis or not, you can reach out to our office for support and we will support you through it.
        </p>
    </div>
    ...
    <div class="section-container scroll-animate">
        ...
        <p class="description">
            Our office has a number of professionals who work with trauma, who you can view below. Once your therapist has met with you and completed their assessment they will make a plan with you to address the symptoms or causes that may be negatively impacting your life. Therapy is most effective when there is a strong connection between the therapist and client, and because of that we encourage you to meet for consults with as many therapists as you need to ensure the best fit.
        </p>
    </div>
