...
ob_start();
session_start();
$pageTitle = "Perinatal Health and Post-Partum Support";
?>
...
<head>
    ...
    <title>Kazimind - <?php echo $pageTitle; ?></title>
</head>

<div class="mainB">

    <div class="section-container section scroll-animate">
        <h1 class="main-heading" style="font-size: 3rem;">Perinatal Health and Post-Partum Support</h1>
