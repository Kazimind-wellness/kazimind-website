...
ob_start();
session_start();
$pageTitle = "Mind-Body Connection";
?>
...
<head>
    ...
    <title>Kazimind - Mind-Body Connection</title>
</head>
...
<div class="mainB">
    ...
    <div class="section-container section scroll-animate">
        ...
        <p class="intro-paragraph">
            <strong>The Mind-Body Connection</strong> refers to the relationship between our mental health and physical health. This relationship can help 
