...
<head>
    ...
    <title>Kazimind - Stress Management</title>
</head>
...
<div class="mainB">
    ...
    <div class="section-container scroll-animate">
        ...
        <p class="description">
            There are many <strong>therapists</strong> on our team who can support you in developing effective <strong>stress management</strong> skills. Working with a <strong>therapist</strong> means having someone by your side to offer guidance and support as you explore the sources of <strong>stress</strong> in your life and how to manage them. At <strong>Kazimind Wellness Centre</strong>, we have a diverse team of <strong>therapists</strong> who are ready to work with you and provide personalized <strong>treatment</strong> that fits your needs.
        </p>
    </div>
